...
- _TilingLayer_B_Porosity @Drawer(Enum, Cardboard, Rock, Brick, CardboardGlossy, Ceramic_Matte, Clay, Coal, Concrete, Dirt, Fabric, Food, Glass, Ice, Metal_Reflective, Metal_Matte)
### Tiling Setting
- _TilingLayer_B_Tiling
- _TilingLayer_B_Use2U @Drawer(Toggle)
- _TilingLayer_B_HexTiling @Drawer(Toggle)
- _TilingLayer_B_MatchScaling @Drawer(Toggle)
### Mask Setting
- _TilingLayer_B_MaskContrast
- _TilingLayer_B_MaskIntensity
### Blend Setting
- _TilingLayer_B_BlendMode @Drawer(Enum, Height Max, Height Min) @Hide(_CustomOption1 <= 0)
- _TilingLayer_B_BlendRadius @Hide(_CustomOption1 <= 0)
#endstylesheet
...
_TilingLayer_B_Porosity ("Porosity", Int) = 0
_TilingLayer_B_Tiling ("Tiling", Float) = 1
_TilingLayer_B_Use2U ("Use 2U", Int) = 0
_TilingLayer_B_HexTiling ("Hex Tiling", Int) = 0
_TilingLayer_B_MatchScaling ("Match Scaling", Int) = 0
_TilingLayer_B_BlendMode ("Blend Mode", Float) = 1
_TilingLayer_B_BlendRadius ("Blend Radius", Range(0.001, 0.5)) = 0.1
_TilingLayer_B_MaskContrast ("Mask Contrast R", Float) = 1
_TilingLayer_B_MaskIntensity ("Mask Intensity R", Float) = 1
...
void PrepareMaterialInput_New(FPixelInput PixelIn, FSurfacePositionData PosData, inout MInputType MInput)
{
	...
	BlendMask.b = saturate(pow(BlendMask.b, _TilingLayer_B_MaskContrast) * _TilingLayer_B_MaskIntensity);
	float2 TilingLayer_B_Coordinate = lerp(PixelIn.UV0, PixelIn.UV1, _TilingLayer_B_Use2U) * _TilingLayer_B_Tiling * lerp(1, LocalScaleX, _TilingLayer_B_MatchScaling);
	...
	{
		BlendWithHeight_Hex(MLayer_B, TilingLayer_B_Coordinate, BlendMask.b, _TilingLayer_B_BlendRadius, _TilingLayer_B_BlendMode, MInput);
	}
	else
	{
		BlendWithHeight(MLayer_B, TilingLayer_B_Coordinate, BlendMask.b, _TilingLayer_B_BlendRadius, _TilingLayer_B_BlendMode, MInput);
	}
#endif
