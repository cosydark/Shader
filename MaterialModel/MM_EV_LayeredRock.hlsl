...
# Topping Layer @Hide(_CustomOption3 == 0)
...
- _ToppingLayer_Porosity @Drawer(Enum, Cardboard, Rock, Brick, CardboardGlossy, Ceramic_Matte, Clay, Coal, Concrete, Dirt, Fabric, Food, Glass, Ice, Metal_Reflective, Metal_Matte)
### Topping Setting
