...
#if XRP_SHADER_INSTANTIATION_META
{
    ...
    "Name": "XRender/Environment/LayeredSurface",
    "OutputPath": "Assets/Res/Shader/SurfaceShaderLibrary/EV_LayeredSurface.shader",
    "MM": "LayeredSurface",
...
namespace UnityEditor.XRender.XShaderGen.Instantiation
{
    ...
    public class EV_LayeredSurfaceShader : XSurfaceShader
    {
        public override string GetName() => "XRender/Environment/LayeredSurface";
        public override string GetOwner() => "QP4B";
        public override string GetDesc() => "HeightBlendTest";
        public override SurfaceShaderUsage GetUsage() => SurfaceShaderUsage.Environment;
        public override string GetGenerateShaderPath() => "Assets/Res/Shader/SurfaceShaderLibrary/EV_LayeredSurface.shader";
        protected override string GetMaterialModelName() => "LayeredSurface";
