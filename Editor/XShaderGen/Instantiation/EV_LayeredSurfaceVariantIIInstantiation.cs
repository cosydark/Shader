...
{
    "ClassName": "EV_LayeredSurfaceVariantII",
    "Name": "XRender/Environment/LayeredSurfaceVariantII",
    "OutputPath": "Assets/Res/Shader/SurfaceShaderLibrary/EV_LayeredSurfaceVariantII.shader",
    "MM": "LayeredSurfaceVariantII",
...
namespace UnityEditor.XRender.XShaderGen.Instantiation
{
    ...
    public class EV_LayeredSurfaceVariantII : XSurfaceShader
    {
        public override string GetName() => "XRender/Environment/LayeredSurfaceVariantII";
        public override string GetOwner() => "QP4B";
        public override string GetDesc() => "";
        public override SurfaceShaderUsage GetUsage() => SurfaceShaderUsage.Environment;
        public override string GetGenerateShaderPath() => "Assets/Res/Shader/SurfaceShaderLibrary/EV_LayeredSurfaceVariantII.shader";
        protected override string GetMaterialModelName() => "LayeredSurfaceVariantII";
